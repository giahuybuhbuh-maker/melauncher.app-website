...
Section "Cai dat ME Launcher" SecInstall
    ...
    CreateShortcut "$DESKTOP\ME Launcher.lnk" "$INSTDIR\ME Launcher.exe" "" "$INSTDIR\ME Launcher.exe" 0
    CreateDirectory "$SMPROGRAMS\ME Launcher"
    CreateShortcut "$SMPROGRAMS\ME Launcher\ME Launcher.lnk" "$INSTDIR\ME Launcher.exe"
